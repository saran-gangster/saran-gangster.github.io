var projectSaran = 
    '<div class="project p-light" id="Saran">' +
    '<a class="overlay" href="project/title.html" target="_blank">' +
    '<div class="content vertical-center">' +
    '</div>' +
    '</a>' +
    '</div>';

var projectUrgentcall =
    '<div class="project p-light" id="p-Urgentcall">' +
    '<a class="overlay" href="https://8c2155dbf49f.ngrok.io" target="_blank">' +
    '<div class="content vertical-center">' +
    '<h4>Developer</h4>' +
    '<h1>Urgentcall <br> Decentralized video calls</h1>' +
...
var projectPixelShooter =
    ...
    '<h1>Pixel Shooter</h1>' +
    '<p>A side-scrolling shooter where its you vs. the enemies!</p>' +
    '<button>Explore <span class="arrow"></span></button>' +
    '</div>' +
    '</a>' +
    '</div>';
...
var ColourMatch =
    ...
    '<h1>Colour Match</h1>' +
    '<p>Simple and addicting flash game, where you match the colours in a rush against time!</p>' +
    '<button>Explore <span class="arrow"></span></button>' +
    '</div>' +
    '</a>' +
    '</div>';
...
var projectColourGame =
    ...
    '<a class="overlay" href="project/color-game.html" target="_blank">' +
    '<div class="content vertical-center">' +
    '<h4>Developer</h4>' +
    '<h1>Color Game</h1>' +
...
var projectBeatVisualizer =
    ...
    '<a class="overlay" href="https://beatvisualize.000webhostapp.com/" target="_blank">' +
    '<div class="content vertical-center">' +
    '<h4>Developer</h4>' +
...
var projectBeautifulTodo =
    ...
    '<a class="overlay" href="project/index.html" target="_blank">' +
    '<div class="content vertical-center">' +
    '<h4>Developer</h4>' +
...
var projectAiChatbot =
    ...
    '<h4>Developer</h4>' +
    '<h1>AI Chatbot</h1>' +
    '<p>Meena uses A gpt-2 dailog model for interacting</p>' +
    '<button>Explore <span class="arrow"></span></button>' +
    '</div>' +
    '</a>' +
    '</div>';
